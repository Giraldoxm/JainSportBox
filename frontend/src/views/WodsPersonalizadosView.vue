            ...
            <div class="flex items-start justify-between gap-4">
              ...
              <div class="flex gap-2 flex-shrink-0">
                <button
                  ...
                  class="p-2 rounded-lg bg-white/10 hover:bg-amber-500/40 transition-colors"
                >
          ...
          >
            ...
            <div class="flex gap-1 flex-shrink-0">
              <button
                ...
                class="p-1.5 rounded-lg text-gray-400 hover:bg-emerald-50 hover:text-emerald-600 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mb-8">
          ...
          >
            ...
            >
              ...
              {{ expandidos[wodDeHoy.id] ? 'Ocultar videos' : `Ver ${wodDeHoy.ejercicios.length} video${wodDeHoy.ejercicios.length !== 1 ? 's' : ''}` }}
            </button>
            <div v-show="expandidos[wodDeHoy.id]" class="mt-3">
              <WodVideosLista :videos="wodDeHoy.ejercicios" dark />
            </div>
          </div>
